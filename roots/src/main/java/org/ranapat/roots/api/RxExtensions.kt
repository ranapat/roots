...
fun <T: Any> Maybe<Response>.instance(valueType: Class<T>): Maybe<T> = string().instance(valueType)
fun <T: Any> Maybe<Response>.instance(normaliseResponse: NormaliseResponse<T>): Maybe<T> = string().map { body ->
